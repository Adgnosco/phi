...
- Las cosas son divisibles y hay un punto en que es imposible dividir, entonces se encuentra la partícula fundamental de todas las cosas. (Atomismo)
	- Un número infinito de átomos y tipos de átomos. (Indeterminismo)
...
- El ser no es y el no-ser es. (Relativismo)
	- La nada es. (Nihilismo)
	- Si algo es, nada puede conocer. (Agnosticismo)
	- Si algo puede conocer, el conocimiento no puede ser comunicado hacia otros. (Escepticismo)
	- Si puede ser comunicado, no puede ser entendido. (Escepticismo)
### Demócrito
...
### Epicuro de Samos
- Debe haber uno que mueva sin ser movido para ser la causa de todo movimiento. (Aristotelismo)
	- No puede haber un dios que motive la acción, ya que son perfectamente felices como para ocupar en el ámbito terrenal. (Politeísmo)
	- 
### San Tomás de Aquino
- 
### Martin Heidegger
